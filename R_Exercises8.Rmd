...
add their ingredients as sub-items in the list. You should enter at least two dishes with two ingredients each.
...
result3<- lm(circumference~age, data=Orange)
summary(result3)
...
[UCLA R Help Website](https://stats.oarc.ucla.edu/r)
